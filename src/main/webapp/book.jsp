...
<script>
const hasSearchFlag = <%= hasSearch ? "true" : "false" %>;
...
if (hasSeatsSection) {
	  // ===== توليد المقاعد ديناميكياً =====
	  const seatGrid = document.getElementById("seatGrid");

	  // عدد الصفوف في العربة (غيّري الرقم إذا تبين مقاعد أكثر)
	  const totalRows = 8;

	  // ترتيب الأعمدة: مقعدين، ممر، مقعدين
	  const seatCols = ["A", "B", "aisle", "C", "D"];
